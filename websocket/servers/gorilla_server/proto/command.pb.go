...
func (x *Command) GetEcho() *Echo {
	if x, ok := x.GetPayload().(*Command_Echo); ok {
		return x.Echo
	}
	return nil
}

func (x *Command) GetIncrement() *Increment {
	if x, ok := x.GetPayload().(*Command_Increment); ok {
		return x.Increment
	}
	return nil
}
...
type Command_Echo struct {
	Echo *Echo `protobuf:"bytes,101,opt,name=echo,proto3,oneof"`
}

type Command_Increment struct {
	Increment *Increment `protobuf:"bytes,102,opt,name=increment,proto3,oneof"`
}

func (*Command_Echo) isCommand_Payload() {}

func (*Command_Increment) isCommand_Payload() {}
...
var file_proto_command_proto_rawDesc = []byte{
	...
	,
...
var file_proto_command_proto_goTypes = []interface{}{
	...
	(*Echo)(nil),      // 1: proto.Echo
	(*Increment)(nil), // 2: proto.Increment
}
var file_proto_command_proto_depIdxs = []int32{
	1, // 0: proto.Command.echo:type_name -> proto.Echo
	2, // 1: proto.Command.increment:type_name -> proto.Increment
